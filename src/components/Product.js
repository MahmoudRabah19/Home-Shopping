      ...
      <div className="tile is-child box notification is-success">
        ...
        }
        {
          ...
          : <div>
              ...
              <p className="product-id">Price in $: { this.props.price }</p>
              <p className="product-id">Description: { this.props.description }</p>
              <p className="product-id">Units in Stock: { this.props.units}</p>
              <p className="product-id">Category: { this.props.category}</p>
            </div>
        }
      </div>
    )
